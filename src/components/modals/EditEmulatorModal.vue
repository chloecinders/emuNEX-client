    ...
    >
        <div v-if="props.emulatorId && editState[props.emulatorId]" class="c-emulator-form">
                        ...
                        <label 
                            ...
                            @keydown.enter.space.prevent="
                                if (editState[props.emulatorId].consoles.includes(c)) {
                                    editState[props.emulatorId].consoles = editState[props.emulatorId].consoles.filter((v: string) => v !== c);
                                } else {
            ...
            <div class="c-emulator-field">
                ...
                <Input v-model="editState[props.emulatorId].input_config_file" placeholder="e.g. %LocalAppData%/vbam/vbam.ini" />
            </div>

            <div class="c-emulator-field">
                <Text variant="label" size="sm">Input Mapper (optional)</Text>
                <Input v-model="editState[props.emulatorId].mapper" placeholder="e.g. vbam" />
            </div>
